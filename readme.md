...
- [SLAMD](https://github.com/BAMresearch/WEBSLAMD) - An open-source web app leveraging data-driven design for cementitious materials via a digital lab twin, complemented by a (materials-agnostic) AI optimization feature. Features UI to interactively explore  design spaces (**Python/Javascript**). [![Github Stars]
